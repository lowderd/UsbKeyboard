...
#define KEY_NUM_1           0x59    // Keyboard Num Pad 1 and End
#define KEY_NUM_2           0x5A    // Keyboard Num Pad 2 and Down Arrow
#define KEY_NUM_3           0x5B    // Keyboard Num Pad 3 and Page Down
#define KEY_NUM_4           0x5C    // Keyboard Num Pad 4 and Left Arrow
#define KEY_NUM_5           0x5D    // Keyboard Num Pad 5 
#define KEY_NUM_6           0x5E    // Keyboard Num Pad 6 and Right Arrow
#define KEY_NUM_7           0x5F    // Keyboard Num Pad 7 and Home
#define KEY_NUM_8           0x60    // Keyboard Num Pad 8 and Up Arrow
#define KEY_NUM_9           0x61    // Keyboard Num Pad 9 and Page Up
#define KEY_NUM_0           0x62    // Keyboard Num Pad 0 and Insert
#define KEY_NUM_PERIOD      0x63    // Keyboard Num Pad .
